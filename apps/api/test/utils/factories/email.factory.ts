/**
 * Email mock factory for creating test email notification data (Nodemailer)
 * This factory is for email sending, NOT the Prisma Notification model.
 * For database notifications, use NotificationMockFactory.
 */
...
export class EmailMockFactory extends BaseMockFactory<MockEmail> {
  protected generateMock(overrides?: DeepPartial<MockEmail>): MockEmail {
  ...
  createPasswordReset(userEmail: string, overrides?: Partial<MockEmail>): MockEmail {
    return this.create({
      to: userEmail,
