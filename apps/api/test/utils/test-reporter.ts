...
export class TestReporter {
  ...
  private generateJsonReport(reportData: ReportData): void {
  ...
  private generateHtmlReport(reportData: ReportData): void {
...
<body>
  ...
  private sendNotifications(reportData: ReportData): void {
  ...
  private sendSlackNotification(reportData: ReportData): void {
