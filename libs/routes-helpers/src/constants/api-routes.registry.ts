...
export interface Endpoints {
  ...
  '/api/accounts/{id}': {
    ...
    PATCH: (body: {
      ...
      disability?: boolean;
      disabilityCause?: Record<string, unknown>;
  ...
  '/api/sessions': {
    GET: (params: {
      ...
      bookingType?: Record<string, unknown>;
    }[];
    POST: (body: {
      bookingTypeId: string;
      timeSlotId: string;
  ...
  '/api/time-slots': {
    ...
    POST: (body: { dateTime: string; durationMin: number; isAvailable: boolean }) => {
      id: string;
      createdAt: string;
      updatedAt: string;
      coachId: string;
