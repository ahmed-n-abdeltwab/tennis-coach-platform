...
export interface Endpoints {
  "/api/accounts": {
    GET: (params: undefined | never, body: undefined | never) => { id: string; createdAt: string; updatedAt: string; email: string; name: string; role: "USER" | "PREMIUM_USER" | "ADMIN" | "COACH"; gender?: "male" | "female" | "other"; age?: number; height?: number; weight?: number; bio?: string; credentials?: string; philosophy?: string; profileImage?: string; disability?: boolean; disabilityCause?: string; country?: string; address?: string; notes?: string; isActive: boolean; isOnline: boolean }[];
  };
  ...
  "/api/accounts/{id}": {
    ...
    GET: (params: { id: string }, body: undefined | never) => { id: string; createdAt: string; updatedAt: string; email: string; name: string; role: "USER" | "PREMIUM_USER" | "ADMIN" | "COACH"; gender?: "male" | "female" | "other"; age?: number; height?: number; weight?: number; bio?: string; credentials?: string; philosophy?: string; profileImage?: string; disability?: boolean; disabilityCause?: string; country?: string; address?: string; notes?: string; isActive: boolean; isOnline: boolean };
  ...
  "/api/booking-types": {
    GET: (params: undefined | never, body: undefined | never) => { id: string; createdAt: string; updatedAt: string; name: string; description?: string; basePrice: number; isActive: boolean; coachId: string; coach: string | null }[];
    POST: (params: undefined | never, body: { name: string; description?: string; basePrice: number }) => { id: string; createdAt: string; updatedAt: string; name: string; description?: string; basePrice: number; isActive: boolean; coachId: string; coach: string | null };
  };

  "/api/booking-types/coach/{coachId}": {
    GET: (params: { coachId: string }, body: undefined | never) => { id: string; createdAt: string; updatedAt: string; name: string; description?: string; basePrice: number; isActive: boolean; coachId: string; coach: string | null }[];
  };

  "/api/booking-types/{id}": {
    DELETE: (params: { id: string }, body: undefined | never) => void;
    GET: (params: { id: string }, body: undefined | never) => { id: string; createdAt: string; updatedAt: string; name: string; description?: string; basePrice: number; isActive: boolean; coachId: string; coach: string | null };
    PATCH: (params: { id: string }, body: { name?: string; description?: string; basePrice?: number; isActive?: boolean }) => { id: string; createdAt: string; updatedAt: string; name: string; description?: string; basePrice: number; isActive: boolean; coachId: string; coach: string | null };
    PUT: (params: { id: string }, body: { name?: string; description?: string; basePrice?: number; isActive?: boolean }) => { id: string; createdAt: string; updatedAt: string; name: string; description?: string; basePrice: number; isActive: boolean; coachId: string; coach: string | null };
  };
  ...
  "/api/messages": {
    GET: (params: { sessionId?: string; conversationWith?: string }, body: undefined | never) => { id: string; createdAt: string; updatedAt: string; content: string; sentAt: string; senderId: string; receiverId: string; sessionId?: string; senderType: "USER" | "PREMIUM_USER" | "ADMIN" | "COACH"; receiverType: "USER" | "PREMIUM_USER" | "ADMIN" | "COACH"; sender?: { id: string; name: string; email: string }; receiver?: { id: string; name: string; email: string } }[];
    POST: (params: undefined | never, body: { content: string; receiverId: string; sessionId?: string }) => { id: string; createdAt: string; updatedAt: string; content: string; sentAt: string; senderId: string; receiverId: string; sessionId?: string; senderType: "USER" | "PREMIUM_USER" | "ADMIN" | "COACH"; receiverType: "USER" | "PREMIUM_USER" | "ADMIN" | "COACH"; sender?: { id: string; name: string; email: string }; receiver?: { id: string; name: string; email: string } };
  };

  "/api/messages/conversation/{userId}": {
    GET: (params: { userId: string }, body: undefined | never) => { id: string; createdAt: string; updatedAt: string; content: string; sentAt: string; senderId: string; receiverId: string; sessionId?: string; senderType: "USER" | "PREMIUM_USER" | "ADMIN" | "COACH"; receiverType: "USER" | "PREMIUM_USER" | "ADMIN" | "COACH"; sender?: { id: string; name: string; email: string }; receiver?: { id: string; name: string; email: string } }[];
  };
  ...
  "/api/messages/{id}": {
    GET: (params: { id: string }, body: undefined | never) => { id: string; createdAt: string; updatedAt: string; content: string; sentAt: string; senderId: string; receiverId: string; sessionId?: string; senderType: "USER" | "PREMIUM_USER" | "ADMIN" | "COACH"; receiverType: "USER" | "PREMIUM_USER" | "ADMIN" | "COACH"; sender?: { id: string; name: string; email: string }; receiver?: { id: string; name: string; email: string } };
  };
