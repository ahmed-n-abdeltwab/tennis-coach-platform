...
export interface Endpoints {
  ...
  "/api/booking-types": {
    GET: (params: undefined | never, body: undefined | never) => { id: string; createdAt: string; updatedAt: string; name: string; description?: string; basePrice: number; isActive: boolean; coachId: string }[];
    POST: (params: undefined | never, body: { name: string; description?: string; basePrice: number }) => { id: string; createdAt: string; updatedAt: string; name: string; description?: string; basePrice: number; isActive: boolean; coachId: string };
  };

  "/api/booking-types/coach/{coachId}": {
    GET: (params: { coachId: string }, body: undefined | never) => { id: string; createdAt: string; updatedAt: string; name: string; description?: string; basePrice: number; isActive: boolean; coachId: string }[];
  };

  "/api/booking-types/{id}": {
    DELETE: (params: { id: string }, body: undefined | never) => void;
    GET: (params: { id: string }, body: undefined | never) => { id: string; createdAt: string; updatedAt: string; name: string; description?: string; basePrice: number; isActive: boolean; coachId: string };
    PATCH: (params: { id: string }, body: { name?: string; description?: string; basePrice?: number; isActive?: boolean }) => { id: string; createdAt: string; updatedAt: string; name: string; description?: string; basePrice: number; isActive: boolean; coachId: string };
    PUT: (params: { id: string }, body: { name?: string; description?: string; basePrice?: number; isActive?: boolean }) => { id: string; createdAt: string; updatedAt: string; name: string; description?: string; basePrice: number; isActive: boolean; coachId: string };
  };
